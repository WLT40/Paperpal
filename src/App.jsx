      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md text-center">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6 text-left">
            ...
            <p className="text-xs text-yellow-700 mb-2">请先下载并运行 PaperPal 后端程序，启动后刷新本页面。</p>
            <p className="text-xs text-yellow-700 font-medium">运行后打开 👉 http://localhost:8000 即可使用</p>
          </div>
          ...
          <p className="text-xs text-gray-400">下载后双击运行，选择任意文件夹储存数据，然后打开 http://localhost:8000 即可使用。</p>
        </div>
      </div>
    );
  }
